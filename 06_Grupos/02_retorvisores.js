...
console.log(texto1.match(/<(\w+)>.*<\/\1>/g)) // \1 representa o  treovisor da capitura     

const texto2 = 'Lentamente é mente muito lenta.'
console.log(texto2.match(/(lenta)(mente).*\2.*\1\./gi))
console.log(texto2.match(/(?:lenta)(mente).*\1/gi)) // ?: não guarda ou seja não cri O RETOVISOR

console.log(texto2.match(/(lenta)(mente)/gi))
console.log(texto2.match(/(lenta)(mente)?/gi))
console.log(texto2.replace(/(lenta)(mente)/gi, 'opa vai retrovidor$2'))
