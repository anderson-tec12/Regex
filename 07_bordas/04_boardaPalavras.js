...
console.log(texto1.match(/\bdia\w+/gi)) // \b é uma borda de palavra
console.log(texto1.match(/\w+dia\b/gi)) // pega as palavras que termina com dia
...
console.log(texto2.match(/([\wÀ-ú-]*)?dia([\wÀ-ú-]*)?/gi)) //aqui corrigimos o problema da virgula vir junto